/**
 * The pure date/billing logic of the Supabase backend, checked against the same
 * expectations as gas-test.mjs checks Code.gs — so the rent-period maths is
 * identical on both sides of the migration.
 */
import { periodsFor, addMonths, monthsBetween, round2, parseDate, fmtDate } from '../supabase/functions/api/backend.js';
